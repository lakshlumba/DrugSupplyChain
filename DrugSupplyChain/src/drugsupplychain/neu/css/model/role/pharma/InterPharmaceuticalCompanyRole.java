/*
 * Class : InterPharmaceuticalCompanyRole.java
 * Developer : Laksh Lumba
 * Reviewer :
 * Description : 
 * Created On : Nov 10, 2014, 12:25:33 AM
 * ---------------------------------------------------------------------------
 * Change History
 * Develper :
 * Reviwer :
...
import drugsupplychain.neu.css.gui.inter.pharmaco.InterPharmaCompanyWorkAreaJPanel;
 ...
 * @author Laksh
 */
public class InterPharmaceuticalCompanyRole extends PharmaceuticalCompanyRole {
    
    /**
     * Enter the international company
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization,Organization higherOrganization,Organization nextHigherOrganization,Organization highestOrganization,FDISystem fDISystem) {
        ...
        return new InterPharmaCompanyWorkAreaJPanel(userProcessContainer,account,organization,fDISystem);
    }
