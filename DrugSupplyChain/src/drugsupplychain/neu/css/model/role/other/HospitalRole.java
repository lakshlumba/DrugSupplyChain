/*
 * Class : HospitalRole.java
 * Developer : Laksh Lumba
 * Reviewer :
 * Description : 
 * Created On : Nov 10, 2014, 12:30:50 AM
 * ---------------------------------------------------------------------------
 * Change History
 * Develper :
 * Reviwer :
...
import drugsupplychain.neu.css.gui.city.lawagency.hospitals.CityHospitalWorkAreaJPanel;
...
public class HospitalRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer,UserAccount userAccount, Organization organization,Organization higherOrganization,Organization nextHigherOrganization,Organization highestOrganization,FDISystem fDISystem) {
        ...
        return new CityHospitalWorkAreaJPanel(userProcessContainer,userAccount,(HospitalOrganization)organization,(CityLawAgency)higherOrganization,(StateLawAgency)nextHigherOrganization);
    }
