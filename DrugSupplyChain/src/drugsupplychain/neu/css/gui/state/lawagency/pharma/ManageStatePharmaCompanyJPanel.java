 ...
 */
package drugsupplychain.neu.css.gui.state.lawagency.pharma;
 ...
 * @author Laksh
 */
public class ManageStatePharmaCompanyJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ManageStatePharmaCompanyJPanel
     * @param userProcessContainer
     * @param stateLawAgency
     */
    public ManageStatePharmaCompanyJPanel(JPanel userProcessContainer,StateLawAgency stateLawAgency) {
        initComponents();
        this.statePharmaceauticalCompanyDirectory = stateLawAgency.getStatePharmaceauticalCompanyDirectory();
    ...
    private void populateNotification(){
        int notification = 0;
        for (StatePharmaceauticalCompany statePharmaceauticalCompany : statePharmaceauticalCompanyDirectory.getStatePharmaceauticalCompanyList()){
            for(WorkRequest workRequest : statePharmaceauticalCompany.getWorkQueue().getWorkRequestList()){
    ...
    private void populateTable(){
        ...
        for (StatePharmaceauticalCompany statePharmaceauticalCompany : statePharmaceauticalCompanyDirectory.getStatePharmaceauticalCompanyList()){
            ...
            row[0] = statePharmaceauticalCompany;
            row[1] = statePharmaceauticalCompany.getOrganizationID();
            row[2] = statePharmaceauticalCompany.getLincense().getLicenseNumber();
            row[3] = statePharmaceauticalCompany.getLincense().isIsLicenseValid();
    ...
    private void populateTable(int pharmaId){
        ...
        defaultTableModel.setRowCount(0);
        for (StatePharmaceauticalCompany statePharmaceauticalCompany : statePharmaceauticalCompanyDirectory.getStatePharmaceauticalCompanyList()){
            if (statePharmaceauticalCompany.getOrganizationID()== pharmaId){
                Object[] row = new Object[4];
                row[0] = statePharmaceauticalCompany;
                row[1] = statePharmaceauticalCompany.getOrganizationID();
                row[2] = statePharmaceauticalCompany.getLincense().getLicenseNumber();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage State Pharama Co.");
        ...
        add(manageLisenceButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 350, 170, 50));
    ...
    private void managePharmaCoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaCoButtonActionPerformed
       RegisterPharmaOrganizationJPanel registerPharmaCOJPanel = new RegisterPharmaOrganizationJPanel(userProcessContainer,statePharmaceauticalCompanyDirectory,stateLawAgency,Type.STATE_PHARMA_CO);
    ...
    private void manageLisenceButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageLisenceButtonActionPerformed
        ...
        if (selectedRow < 0 ){
            ...
            StatePharmaceauticalCompany statePharmaceauticalCompany = (StatePharmaceauticalCompany)pharmaTable.getValueAt(selectedRow, 0);
            ManagePharmaCoLisenceJPanel managePharmaCoLisenceJPanel =  new ManagePharmaCoLisenceJPanel(userProcessContainer,statePharmaceauticalCompany,Type.STATE_PHARMA_CO);
    ...
    private void managePharmaProductButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductButtonActionPerformed
        ...
        if (selectedRow < 0 ){
            ...
            StatePharmaceauticalCompany statePharmaceauticalCompany = (StatePharmaceauticalCompany)pharmaTable.getValueAt(selectedRow, 0);
            ManagePharmaRequestsJPanel managePharmaRequestsJPanel =  new ManagePharmaRequestsJPanel(userProcessContainer,statePharmaceauticalCompany);
    ...
    private void managePharmaProductButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductButton1ActionPerformed
        ...
        if (selectedRow < 0 ){
            ...
            StatePharmaceauticalCompany statePharmaceauticalCompany = (StatePharmaceauticalCompany)pharmaTable.getValueAt(selectedRow, 0);
            ManagePharmaProductJPanel managePharmaProductJPanel =  new ManagePharmaProductJPanel(userProcessContainer,statePharmaceauticalCompany.getProductCatalog(),statePharmaceauticalCompany);
