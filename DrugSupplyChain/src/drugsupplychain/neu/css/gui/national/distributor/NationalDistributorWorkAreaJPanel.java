/*
 * Class : NationalDistributorWorkAreaJPanel.java
 ...
 */
package drugsupplychain.neu.css.gui.national.distributor;
...
public class NationalDistributorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private final NationalDistributor nationalDistributor;
     ...
     * @param fDISystem
     */
    public NationalDistributorWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization,NationalLawAgency nationalLawAgency,RegionalLawAgency regionalLawAgency,FDISystem fDISystem) {
        initComponents();
        ImplLogger.enterMethod();        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        this.nationalDistributor = (NationalDistributor)organization; 
    ...
    private void enableFunctionality(){
        ...
        if (!nationalDistributor.getLincense().isIsLicenseValid()){
            ImplLogger.info("NationalDistributor lincense is not valid");
            ...
            ImplLogger.info("NationalDistributor lincense is valid");
    ...
    private void initComponents() {
        ...
        distributorsRequest.setText("Manage State Distributors ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(distributorsRequest, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(distributorsRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(manageRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(updateContact, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 910, 600));
    ...
    private void managePharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductActionPerformed
       ImplLogger.enterMethod();
       ManageProductCatalogJPanel manageProductCatalogJPanel = new ManageProductCatalogJPanel(userProcessContainer,nationalDistributor);
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
       ImplLogger.enterMethod();
       UpdateContactJPanel updateContactJPanel = new UpdateContactJPanel(userProcessContainer,nationalDistributor);
    ...
    private void createProductRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequestActionPerformed
       ImplLogger.enterMethod();
       CreateRequestForProductJPanel createRequestForProductJPanel = new CreateRequestForProductJPanel(userProcessContainer,userAccount,nationalDistributor,regionalLawAgency,fDISystem);
    ...
    private void shopPharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopPharmaProductActionPerformed
       ImplLogger.enterMethod();
       BrowseProductCatalogJPanel browseProductCatalogJPanel = new BrowseProductCatalogJPanel(userProcessContainer,nationalDistributor,regionalLawAgency,fDISystem);
    ...
    private void distributorsRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distributorsRequestActionPerformed
        ImplLogger.enterMethod();
        ManageDistributorsJPanel manageDistributorsJPanel = new ManageDistributorsJPanel(userProcessContainer,userAccount,nationalDistributor,nationalLawAgency);
    ...
    private void manageRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageRequestActionPerformed
        ImplLogger.enterMethod();
        ManageWorkRequestsJPanel manageWorkRequestsJPanel = new ManageWorkRequestsJPanel(userProcessContainer,nationalDistributor,userAccount);
