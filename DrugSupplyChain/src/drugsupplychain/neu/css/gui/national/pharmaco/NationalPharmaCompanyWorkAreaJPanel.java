/*
 * Class : NationalPharmaCompanyWorkAreaJPanel.java
 ...
 */
package drugsupplychain.neu.css.gui.national.pharmaco;
 ...
 * @author Laksh
 */
public class NationalPharmaCompanyWorkAreaJPanel extends javax.swing.JPanel {
    private final JPanel userProcessContainer;
    private final UserAccount userAccount;
    private final NationalPharmaceauticalCompany nationalPharmaceauticalCompany;
    private final LawAgency lawAgency;
    private final FDISystem fDISystem;
    /**
     * Creates new form NationalPharmaCompanyWorkAreaJPanel
     ...
     * @param fDISystem
     */
    public NationalPharmaCompanyWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization,LawAgency lawAgency,FDISystem fDISystem) {
        initComponents();
        ImplLogger.enterMethod();
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        this.nationalPharmaceauticalCompany = (NationalPharmaceauticalCompany)organization;
    ...
    /**
     * enable the functionality of nationalPharmaceauticalCompany
     */
    private void enableFunctionality(){
        ImplLogger.enterMethod();
        if (!nationalPharmaceauticalCompany.getLincense().isIsLicenseValid()){
            ImplLogger.info("NationalPharmaceauticalCompany lincense is not valid");
            managePharmaProduct.setEnabled(false);
            manageRequest.setEnabled(false);
            distributorsRequest.setEnabled(false);
        } else{
            ImplLogger.info("NationalPharmaceauticalCompany lincense is valid");
    ...
    private void initComponents() {
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 920, 540));
    ...
    private void managePharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductActionPerformed
       ImplLogger.enterMethod();
        ManageProductCatalogJPanel manageProductCatalogJPanel = new ManageProductCatalogJPanel(userProcessContainer,nationalPharmaceauticalCompany);
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
       ImplLogger.enterMethod();
        UpdateContactJPanel updateContactJPanel = new UpdateContactJPanel(userProcessContainer,nationalPharmaceauticalCompany);
    ...
    private void manageRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageRequestActionPerformed
       ImplLogger.enterMethod();
       ManageWorkRequestsJPanel manageWorkRequestsJPanel = new ManageWorkRequestsJPanel(userProcessContainer,nationalPharmaceauticalCompany,userAccount);
    ...
    private void distributorsRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distributorsRequestActionPerformed
        ImplLogger.enterMethod();
        ManageDistributorsJPanel manageDistributorsJPanel = new ManageDistributorsJPanel(userProcessContainer,userAccount,nationalPharmaceauticalCompany,lawAgency);
