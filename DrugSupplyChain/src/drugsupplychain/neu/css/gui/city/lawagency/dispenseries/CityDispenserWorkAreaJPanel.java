 ...
 * @author Laksh
 */
public class CityDispenserWorkAreaJPanel extends javax.swing.JPanel {
    private final JPanel userProcessContainer;
    private final UserAccount userAccount;
    private final DispenceryOrganization dispenceryOrganization;
    private final StateLawAgency stateLawAgency;
    private final CityLawAgency cityLawAgency;
    /**
     * Creates new form CityDispenserWorkAreaJPanel
     * @param userProcessContainer
     * @param userAccount
     * @param dispenceryOrganization
     * @param cityLawAgency
     * @param stateLawAgency
     */
    public CityDispenserWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount,DispenceryOrganization dispenceryOrganization,CityLawAgency cityLawAgency,StateLawAgency stateLawAgency) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        this.dispenceryOrganization = dispenceryOrganization;
    ...
    private void enableFunctionality(){
        ...
        if (!dispenceryOrganization.getLincense().isIsLicenseValid()){
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(registerPateint, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(createProductRequest2, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 1070, 570));
    ...
    private void managePharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductActionPerformed
       ManageProductCatalogJPanel manageProductCatalogJPanel = new ManageProductCatalogJPanel(userProcessContainer,dispenceryOrganization);
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
       UpdateContactJPanel updateCityDistributorContactJPanel = new UpdateContactJPanel(userProcessContainer,dispenceryOrganization);
    ...
    private void createProductRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequestActionPerformed
       CreateRequestForProductJPanel createRequestForProductJPanel = new CreateRequestForProductJPanel(userProcessContainer,userAccount,dispenceryOrganization,cityLawAgency,null);
    ...
    private void shopPharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopPharmaProductActionPerformed
       BrowseProductCatalogJPanel browseProductCatalogJPanel = new BrowseProductCatalogJPanel(userProcessContainer,dispenceryOrganization,stateLawAgency,null);
    ...
    private void createProductRequest2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequest2ActionPerformed
        ReportCaseAgainstMedicationJPanel reportCaseAgainstMedicationJPanel = new ReportCaseAgainstMedicationJPanel(userProcessContainer,userAccount,dispenceryOrganization,dispenceryOrganization.getProductCatalog());
    ...
    private void registerPateintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerPateintActionPerformed
        ManageCityPatientJPanel manageCityPatientJPanel = new ManageCityPatientJPanel(userProcessContainer,dispenceryOrganization,cityLawAgency);
