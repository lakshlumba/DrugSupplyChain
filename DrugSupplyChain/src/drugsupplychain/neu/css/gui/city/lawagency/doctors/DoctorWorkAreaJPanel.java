...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
     ...
     * @param userAccount
     * @param doctorOrganization
     * @param cityLawAgency
     * @param stateLawAgency
     */
    public DoctorWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount,DoctorOrganization doctorOrganization,CityLawAgency cityLawAgency,StateLawAgency stateLawAgency) {
        initComponents();
    ...
    /**
     * enable the functionality of DoctorOrganization
     */
    private void enableFunctionality(){
        ImplLogger.enterMethod();
        if (!doctorOrganization.getLincense().isIsLicenseValid()){
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(createProductRequest, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(createProductRequest2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addContainerGap()
                    ...
                    .addComponent(registerPateint, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(9, 9, 9)
                .addComponent(shopPharmaProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(createProductRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(createProductRequest2, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(registerPateint, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(updateContact, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 970, 570));
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
       UpdateContactJPanel updateCityDistributorContactJPanel = new UpdateContactJPanel(userProcessContainer,doctorOrganization);
    ...
    private void createProductRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequestActionPerformed
       CreateRequestForProductJPanel createRequestForProductJPanel = new CreateRequestForProductJPanel(userProcessContainer,userAccount,doctorOrganization,stateLawAgency,null);
    ...
    private void shopPharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopPharmaProductActionPerformed
       BrowseProductCatalogJPanel browseProductCatalogJPanel = new BrowseProductCatalogJPanel(userProcessContainer,doctorOrganization,stateLawAgency,null);
    ...
    private void createProductRequest2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequest2ActionPerformed
       ReportCaseAgainstMedicationJPanel reportCaseAgainstMedicationJPanel = new ReportCaseAgainstMedicationJPanel(userProcessContainer,userAccount,doctorOrganization,doctorOrganization.getProductCatalog());
    ...
    private void registerPateintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerPateintActionPerformed
        ManageCityPatientJPanel manageCityPatientJPanel = new ManageCityPatientJPanel(userProcessContainer,doctorOrganization,cityLawAgency);
