 ...
 * @author Laksh
 */
public class CityHospitalWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public CityHospitalWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount,HospitalOrganization hospitalOrganization,CityLawAgency cityLawAgency,StateLawAgency stateLawAgency) {
        initComponents();
    ...
    private void initComponents() {
        ...
        reportProductRequest = new javax.swing.JButton();
        ...
        reportProductRequest.setBackground(new java.awt.Color(255, 255, 255));
        reportProductRequest.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        reportProductRequest.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drugsupplychain/images/Folder.png"))); // NOI18N
        reportProductRequest.setText("Report Case Against Product ");
        reportProductRequest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reportProductRequestActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(updateContact, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(createProductRequest, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(managePharmaProduct, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(shopPharmaProduct, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(reportProductRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(registerPateint, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(635, 635, 635))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(managePharmaProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(shopPharmaProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(createProductRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(reportProductRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(registerPateint, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 1030, 760));
    ...
    private void registerPateintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerPateintActionPerformed
        ManageCityPatientJPanel manageCityPatientJPanel = new ManageCityPatientJPanel(userProcessContainer,hospitalOrganization,cityLawAgency);
    ...
    private void reportProductRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportProductRequestActionPerformed
        ReportCaseAgainstMedicationJPanel reportCaseAgainstMedicationJPanel = new ReportCaseAgainstMedicationJPanel(userProcessContainer,userAccount,hospitalOrganization,hospitalOrganization.getProductCatalog());
        userProcessContainer.add("ReportCaseAgainstMedicationJPanel",reportCaseAgainstMedicationJPanel);
        CardLayout cardLayout = (CardLayout)userProcessContainer.getLayout();
        cardLayout.next(userProcessContainer);
    }//GEN-LAST:event_reportProductRequestActionPerformed
    ...
    private void shopPharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopPharmaProductActionPerformed
        BrowseProductCatalogJPanel browseProductCatalogJPanel = new BrowseProductCatalogJPanel(userProcessContainer,hospitalOrganization,stateLawAgency,null);
    ...
    private void createProductRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProductRequestActionPerformed
        CreateRequestForProductJPanel createRequestForProductJPanel = new CreateRequestForProductJPanel(userProcessContainer,userAccount,hospitalOrganization,cityLawAgency,null);
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
        UpdateContactJPanel updateCityDistributorContactJPanel = new UpdateContactJPanel(userProcessContainer,hospitalOrganization);
    ...
    private void managePharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductActionPerformed
        ManageProductCatalogJPanel manageProductCatalogJPanel = new ManageProductCatalogJPanel(userProcessContainer,hospitalOrganization);
    ...
    private javax.swing.JButton reportProductRequest;
