 ...
 */
package drugsupplychain.neu.css.gui.regional.pharmaco;
 ...
 * @author Laksh
 */
public class RegionalPharmaCompanyWorkAreaJPanel extends javax.swing.JPanel {
    private final JPanel userProcessContainer;
    private final UserAccount userAccount;
    private final RegionalPharmaceauticalCompany regionalPharmaceauticalCompany;
     ...
     * @param fDISystem
     */
    public RegionalPharmaCompanyWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization,LawAgency lawAgency,FDISystem fDISystem) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        this.regionalPharmaceauticalCompany = (RegionalPharmaceauticalCompany)organization;
    ...
    /**
     * enable the functionality of RegionalPharmaCompany
     */
    private void enableFunctionality(){
        ImplLogger.enterMethod();
        if (!regionalPharmaceauticalCompany.getLincense().isIsLicenseValid()){
            ImplLogger.info("regionalPharmaceauticalCompany lincense is not valid");
            managePharmaProduct.setEnabled(false);
            manageRequest.setEnabled(false);
            distributorsRequest.setEnabled(false);
        } else{
            ImplLogger.info("regionalPharmaceauticalCompany lincense is valid");
    ...
    private void initComponents() {
        ...
        add(jSplitPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 800, 550));
    ...
    private void managePharmaProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managePharmaProductActionPerformed
       ImplLogger.enterMethod();
        ManageProductCatalogJPanel manageProductCatalogJPanel = new ManageProductCatalogJPanel(userProcessContainer,regionalPharmaceauticalCompany);
    ...
    private void updateContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateContactActionPerformed
       ImplLogger.enterMethod();
        UpdateContactJPanel updateContactJPanel = new UpdateContactJPanel(userProcessContainer,regionalPharmaceauticalCompany);
    ...
    private void manageRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageRequestActionPerformed
       ImplLogger.enterMethod();
       ManageWorkRequestsJPanel manageWorkRequestsJPanel = new ManageWorkRequestsJPanel(userProcessContainer,regionalPharmaceauticalCompany,userAccount);
    ...
    private void distributorsRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distributorsRequestActionPerformed
        ImplLogger.enterMethod();
        ManageDistributorsJPanel manageDistributorsJPanel = new ManageDistributorsJPanel(userProcessContainer,userAccount,regionalPharmaceauticalCompany,lawAgency);
